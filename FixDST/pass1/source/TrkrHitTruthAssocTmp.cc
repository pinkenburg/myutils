/**
 * @file trackbase/TrkrHitTruthAssocTmp.cc
 * @author D. McGlinchey
 * @date June 2018
 * @brief Implementation of TrkrHitTruthAssocTmp
 */
...
TrkrHitTruthAssocTmp::TrkrHitTruthAssocTmp()
  : m_map()
{
}
...
void
TrkrHitTruthAssocTmp::Reset()
{
m_map.clear();
}

void
TrkrHitTruthAssocTmp::identify(std::ostream &os) const
{
...
void
TrkrHitTruthAssocTmp::addAssoc(const TrkrDefs::hitsetkey hitsetkey, const TrkrDefs::hitkey hitkey, const PHG4HitDefs::keytype g4hitkey)
{
...
void
TrkrHitTruthAssocTmp::findOrAddAssoc(const TrkrDefs::hitsetkey hitsetkey, const TrkrDefs::hitkey hitkey, const PHG4HitDefs::keytype g4hitkey)
{
  // the association we want is between TrkrHit and PHG4Hit, but we need to know which TrkrHitSet the TrkrHit is in
...
void
TrkrHitTruthAssocTmp::removeAssoc(const TrkrDefs::hitsetkey hitsetkey, const TrkrDefs::hitkey hitkey)
{
...
void
//TrkrHitTruthAssocTmp::ConstRange
TrkrHitTruthAssocTmp::getG4Hits(const TrkrDefs::hitsetkey hitsetkey, const unsigned int hidx, MMap &temp_map)
{
  //MMap temp_map;
