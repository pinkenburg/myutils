/**
 * @file trackbase/TrkrClusterContainerTmp.h
 * @author D. McGlinchey
 * @date June 2018
 * @brief Cluster container object
 */
#ifndef TRACKBASE_TRKRCLUSTERCONTAINERTMP_H
#define TRACKBASE_TRKRCLUSTERCONTAINERTMP_H
 ...
 */
class TrkrClusterContainerTmp : public PHObject
{
 public:
  ...
  TrkrClusterContainerTmp(){}

  virtual ~TrkrClusterContainerTmp() {}
  void Reset();
 ...
 protected:
  Map m_clusmap;
  ClassDef(TrkrClusterContainerTmp, 1)
};

#endif //TRACKBASE_TRKRCLUSTERCONTAINERTMP_H
